...
<section class="px-6 py-8">
    ...
    <main class="max-w-lg mx-auto mt-10 bg-gray-100 border border-gray-200 p-6 rounded-xl">
      <form method="POST" action="/register"  class="mt-10">
        @csrf
         <div class="mb-6">
             <label for="name" class="block mb-2 py-2 uppercase font-bold text-xs text-gray-700">
               Name
             </label>
            ...
            <div class="mb-6">
             <label for="username" class="block mb-2 py-2 uppercase font-bold text-xs text-gray-700">
               Username
             </label>
            ...
            <div class="mb-6">
             <label for="email" class="block mb-2 py-2 uppercase font-bold text-xs text-gray-700">
               Email
             </label>
            ...
            <div class="mb-6">
             <label for="password" class="block mb-2 py-2 uppercase font-bold text-xs text-gray-700">
               Password
             </label>
